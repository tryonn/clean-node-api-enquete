...
import { LoadAccountByEmailRepository, UpdateAccessTokenRepository, AccountModel, AuthenticationModel, TokenGenerator, HashComparer } from './db-authentication-protocols';
